...
<div class="ml-5">
    <div class="form-group options-section">
        <button class="options btn btn-primary btn-warning mr-5">{{ __('Design With Diagram') }}</button>
    ...
    <div class="design with-diagram">
        ...
        <div class="position-relative">
            ...
            @endif --}}
            <div class="col-lg-12" id="diagram-img">
...
@section('js')
    ...
    @else
        <script src="{{ asset('js/show_design_without_diagram.js') }}"></script>
    @endif
@endsection
