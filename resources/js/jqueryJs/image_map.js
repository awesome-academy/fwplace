        ...
        d = {
            ...
            init: function(e, f) {
                ...
                if (!e) {
                    ...
                    (i[0].onload = function() {
                        ...
                        c[e].options.src.length > 0 &&
                            i.attr('src', c[e].options.src),
            ...
            bindEvents: function(b) {
                ...
                f.on('mousemove touchmove', function(f) {
                    ...
                    a.each(c[b].area[m].coords, function(a, b) {
                        var c = {
                            naturalX:
                                b.naturalX +
                                Math.round((k.clientX - h.clientX) * l.ratioX),
                            naturalY:
                                b.naturalY +
                                Math.round((k.clientY - h.clientY) * l.ratioY)
                        };
                        c.naturalX < 0 || c.naturalX >= n[0].naturalWidth
                            ? (p = !0)
                            : (c.naturalY < 0 ||
                                  c.naturalY >= n[0].naturalHeight) &&
                              (p = !0),
                            (o[a] = c);
                    }),
                        p ||
                    ...
                    f.on('mouseup touchend mouseleave touchleave', function(a) {
                        var b =
                            'undefined' != typeof a.originalEvent.touches || !1;
                        g && (0 === a.button || b) && (g = !1);
                    }),
                    f.on(
                ...
                f.on('mousemove touchmove', function(a) {
                    ...
                    (c[b].area[i.data('areaIndex')].coords[
                        i.data('coordIndex')
                    ] = g),
                    ...
                    f.on(
                        ...
                        function(b) {
                            var c =
                                'undefined' != typeof b.originalEvent.touches ||
                                !1;
                    ...
                    f.on('mouseup touchend', '.image-mapper-point', function(
                        f
                    ) {
                        2 == f.button &&
                    ...
                    e
                        ? ((i.naturalX = Math.round(
                          ...
                          (i.naturalY = Math.round(
                              (c.originalEvent.targetTouches[0].pageY - g.top) *
                                  h.ratioY
                          )))
                        : ((i.naturalX = Math.round(
                              (c.clientX +
